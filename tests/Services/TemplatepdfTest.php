 ...
 */
#[CoversNothing]
final class TemplatepdfTest extends TestCase
{
    ...
    public function testRetrieve(): void
    {
        ...
        $result = $this->client->templatepdf->retrieve(
    ...
    #[Test]
    public function testGetEditLink(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Prism tests are disabled');
        }

        $result = $this->client->templatepdf->getEditLink(
            '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e'
        );
